...
class MLModel(MLModelData):
    ...
    model_id: str = Field(None, title="id under which model is stored in gridfs")
...
class MLAlgorithm(MLAlgorithmData):
    ...
    algorithm_id: str = Field(None, title="id under which algorithm is stored in gridfs")
...
class MLCollector(MLCollectorData):
    ...
    collector_id: str = Field(None, title="id under which collector is stored in gridfs")